...
class SIDiffusionDatasetLoader(object):
    """SI epidemic diffusion simulation dataset on German NUTS3 regions.
    ...
    def _read_web_data(self):
        signal_url = (
            ...
            "SI_diffusion_equation/SI_equation_dataset.npy"
        )
        adj_url = (
            "https://raw.githubusercontent.com/Jostarndt/"
            "Synthetic_Datasets_for_Temporal_Graphs/main/data/"
            "SI_diffusion_equation/nuts3_adjacent_distances.pt"
        )
    ...
    def get_dataset(self, lags: int = 4) -> StaticGraphTemporalSignal:
        """Returns the SI diffusion dataset iterator.

        Args:
            lags (int): Number of time lags. Defaults to 4.
            
        Returns:
            StaticGraphTemporalSignal: The SI diffusion dataset.
        """
        self.lags = lags
